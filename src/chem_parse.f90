      ...
      IF(INDEX(REAC,KEY_BOLS).GT.0.OR.INDEX(REAC,KEY_BOLS_LCASE).GT.0) &
       THEN
      ...
      CHARACTER(LEN=NSMX) :: COLMS(2*NSPEC)
      CHARACTER(LEN=*) :: THIRD_BODY_SPEC(NSPEC)
