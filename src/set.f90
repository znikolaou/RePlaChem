      SUBROUTINE GET_SPECIES_SET(NSPEC,NTRG,INDX_TRG,SPSET_TRGUP, &
                               SPSET_UNION)
      IMPLICIT NONE
      ...
      END
      !-----------------------------------------------------------------
      SUBROUTINE GET_REACTION_SET(NSPEC,NREAC,SPEC,REAC,RSPEC, &
                                  SPSET_UNION,RESET_UNION)
      IMPLICIT NONE
      INTEGER :: I,J,N,NSPEC,NREAC,IPROD,CHECK,RSPEC(NREAC,NSPEC), &
                 SPSET_UNION(NSPEC),RESET_UNION(NREAC)
      CHARACTER(LEN=*) :: SPEC(NSPEC),REAC(NREAC)
