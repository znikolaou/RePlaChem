      ...
      CHARACTER(LEN=NSMX) :: CREAC(NWRKC),CREAC_F(NWRKC)
      CHARACTER(LEN=NSMX) :: CSPEC(NWRKC)
      ...
      CALL PARSE_INDEX_AND_STRING(DIR//CHEMFL,NSMX,NWRKC,NREAC, &
              CREAC)   
      CALL PARSE_INDEX_AND_STRING(DIR//SPECFL,NSMX,NWRKC,NSPEC, &
              CSPEC)
