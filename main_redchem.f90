...
!-----------------------------------------------------------------------
!
      CHARACTER(LEN=NSTR_REMX) :: CREACNM_S(NWRKC),CREACNM_F(NWRKC)
      CHARACTER(LEN=NSTR_SPMX) :: CSPECNM_S(NWRKC),CSPECNM_F(NWRKC)
      INTEGER :: I,J,K,N,NSPEC,NREAC,LCREAC,LCSPEC,IPROD
!
      CHARACTER(LEN=NSTR_REMX), ALLOCATABLE :: CREAC(:)
      CHARACTER(LEN=NSTR_SPMX), ALLOCATABLE :: CSPEC(:),CSPEC_KPP(:)
...
!-----------------------------------------------------------------------
      ...
      CALL READ_CHEM(INDIR,FLCASE,CHEMFILE,SPECFILE,DNUFILE, &
                     CREACNM_S,CSPECNM_S, &
                     CREACNM_F,CSPECNM_F, &
                     NREAC,NSPEC)
